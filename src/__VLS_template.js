import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name, name, arrayColores, activo } from './App.vue';
...
({} as __VLS_IntrinsicElements).br; ({} as __VLS_IntrinsicElements).br; ({} as __VLS_IntrinsicElements).br;
...
(__VLS_ctx.name.toUpperCase());
(__VLS_3.slots!).default;
}
{
const __VLS_5 = ({} as __VLS_IntrinsicElements)["br"];
...
(__VLS_ctx.arrayColores);
(__VLS_13.slots!).default;
}
{
const __VLS_15 = ({} as __VLS_IntrinsicElements)["br"];
...
{
const __VLS_20 = ({} as __VLS_IntrinsicElements)["h2"];
const __VLS_21 = __VLS_elementAsFunctionalComponent(__VLS_20);
({} as __VLS_IntrinsicElements).h2;
({} as __VLS_IntrinsicElements).h2;
const __VLS_22 = __VLS_21({ ...{}, style: ((`color: ${__VLS_ctx.arrayColores[2]}`)), }, ...__VLS_functionalComponentArgsRest(__VLS_21));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_20, typeof __VLS_22> & Record<string, unknown>) => void)({ ...{}, style: ((`color: ${__VLS_ctx.arrayColores[2]}`)), });
const __VLS_23 = __VLS_pickFunctionalComponentCtx(__VLS_20, __VLS_22)!;
let __VLS_24!: __VLS_NormalizeEmits<typeof __VLS_23.emit>;
(__VLS_23.slots!).default;
}
{
const __VLS_25 = ({} as __VLS_IntrinsicElements)["br"];
...
// @ts-ignore
[name, arrayColores, arrayColores, arrayColores, activo,];
}
else if (!__VLS_ctx.activo === false) {
{
